...
<!-- start main -->
            ...
            <div class="page-wrapper">
										...
										<tr>
                                            ...
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#edit${department.DepartmentId}"><i class="fa-solid fa-pencil m-r-5"></i> Edit</a>
                                                    <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#delete${department.DepartmentId}"><i class="fa-regular fa-trash-can m-r-5"></i> Delete</a>
                                                </div>
												</div>
											</td>
										</tr>
										<!-- Edit Department Modal -->
				<div id="edit${department.DepartmentId}" class="modal custom-modal fade" role="dialog">
							...
							<div class="modal-body">
								<form action="/editDepartment" method="post">
									<div class="input-block mb-3">
										...
										<input class="form-control" value="${department.DepartmentName}"  name="departmentname" type="text">
										<input class="form-control" value="${department.DepartmentId}" name="departmentid" type="hidden">
									</div>
				...
				<div class="modal custom-modal fade" id="delete${department.DepartmentId}" role="dialog">
						...
						<div class="modal-content">
							<div class="modal-body">
								...
								<div class="modal-btn delete-action">
									<div class="row">
										<div class="col-6">
											<a href="/deleteDepartment?departmentid=${department.DepartmentId}" class="btn btn-primary continue-btn">Delete</a>
										</div>
										<div class="col-6">
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								<form action="/department" method="post">
									<div class="input-block mb-3">
										<label class="col-form-label">Department Name <span class="text-danger">*</span></label>
										<input class="form-control" type="text" name="department" required="required"/>
									</div>
									<div class="submit-section">
										<button class="btn btn-primary submit-btn" type="submit">Add Department</button>
									</div>
								</form>
							</div>
						</div>
