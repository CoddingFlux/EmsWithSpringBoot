...
<%@include  file="../includes/sidebar.jsp"%>
            ...
            <div class="page-wrapper">
						...
						<div class="col-md-12">
							<div class="table-responsive">
								<table class="table table-striped custom-table mb-0">
									...
									<tbody>
									<c:forEach items="${holidaylist}" var="holist">		
										<tr class="holiday-upcoming">
											<td>${holist.HolidayId}</td>
											<td>${holist.HolidayName}</td>
											<td>${holist.HolidayDate}</td>
											<td class="text-end">
												<div class="dropdown dropdown-action">
													<a href="#" class="action-icon dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"><i class="material-icons">more_vert</i></a>
													<div class="dropdown-menu dropdown-menu-right">
														<a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#edit_holiday${holist.HolidayId}"><i class="fa-solid fa-pencil m-r-5"></i> Edit</a>
														<a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#delete_holiday${holist.HolidayId}"><i class="fa-regular fa-trash-can m-r-5"></i> Delete</a>
													</div>
												</div>
											</td>
										</tr>
										...
										<!-- Edit Holiday Modal -->
				<div class="modal custom-modal fade" id="edit_holiday${holist.HolidayId}" role="dialog">
					<div class="modal-dialog modal-dialog-centered" role="document">
						<div class="modal-content">
							...
							<div class="modal-body">
								<form action="editholiday" method="post">
									<div class="input-block mb-3">
										<label class="col-form-label">Holiday Name <span class="text-danger">*</span></label>
										<input class="form-control" value="${holist.HolidayName}" name="holidayname" type="text" required="required">
									<input  value="${holist.HolidayId}" name="holidayid" type="hidden">
								
									</div>
									<div class="input-block mb-3">
										<label class="col-form-label">Holiday Date <span class="text-danger">*</span></label>
										<div class="cal-icon"><input class="form-control datetimepicker" value="${holist.HolidayDate}" name="holidaydate" type="text" required="required"></div>
									</div>
				...
				<div class="modal custom-modal fade" id="delete_holiday${holist.HolidayId}" role="dialog">
						...
						<div class="modal-content">
							<div class="modal-body">
								...
								<div class="modal-btn delete-action">
									<div class="row">
										<div class="col-6">
											<a href="deleteholiday?holidayid=${holist.HolidayId}" class="btn btn-primary continue-btn">Delete</a>
										</div>
										<div class="col-6">
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								<form action="holidays" method="post" >
									<div class="input-block mb-3">
										<label class="col-form-label">Holiday Name <span class="text-danger">*</span></label>
										<input class="form-control" type="text" name="holidayname" required="required">
									</div>
									<div class="input-block mb-3">
										<label class="col-form-label">Holiday Date <span class="text-danger">*</span></label>
										<div class="cal-icon"><input class="form-control datetimepicker" type="text" name="holidaydate" required="required"></div>
									</div>
									<div class="submit-section">
