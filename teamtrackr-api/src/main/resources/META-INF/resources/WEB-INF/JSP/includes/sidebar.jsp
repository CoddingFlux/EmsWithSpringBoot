					...
					<div id="sidebar-menu" class="sidebar-menu">
						<nav class="greedys sidebar-horizantal">
							<ul class="list-inline-item list-unstyled links">
								...
								<li class="submenu">
									<a href="/employees"><i class="la la-dashboard"></i> <span> Dashboard</span> <!-- <span class="menu-arrow"></span> --></a>
									<!-- <ul>
								...
								<li class="submenu">
									...
									<ul>
									 ...
									 -->	
									 	<li><a href="/employeeLeave">Leaves (Employee)</a></li>
										<li><a href="/leavesettings">Leave Settings</a></li>
										<!-- <li><a href="attendance.html">Attendance (Admin)</a></li>
										<li><a href="attendance-employee.html">Attendance (Employee)</a></li> -->
									<li><a href="/company">Companys</a></li>
						 ...
						 <ul class="sidebar-vertical">
							...
							<li class="submenu">
								...
								<ul>
									<li><a  class="active" href="/employees">Admin Dashboard</a></li>
									<!-- <li><a  href="employee-dashboard.html">Employee Dashboard</a></li> -->
								</ul>
							</li>
							<!-- <li class="submenu">
					...
					<div class="sidebar-right">
						<div class="tab-content" id="v-pills-tabContent">
							<div class="tab-pane fade show active" id="v-pills-dashboard" role="tabpanel" aria-labelledby="v-pills-dashboard-tab">
								...
								<ul>
									<li>
										<a href="/employees" class="active">Admin Dashboard</a>
									</li>
									<!-- <li>
