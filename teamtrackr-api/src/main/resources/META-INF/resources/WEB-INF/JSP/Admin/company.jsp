...
<!-- start main -->
            ...
            <div class="page-wrapper">
					...
					<div class="page-header">
						<div class="row align-items-center">
							...
							<div class="col-auto float-end ms-auto">
								<a href="#" class="btn add-btn" data-bs-toggle="modal" data-bs-target="#add_department"><i class="fa-solid fa-plus"></i> Add Company</a>
							</div>
						</div>
					</div>
					<!-- /Page Header -->
										...
										<tr>
                                            ...
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#edit${company.CompanyId}"><i class="fa-solid fa-pencil m-r-5"></i> Edit</a>
                                                    <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#delete${company.CompanyId}"><i class="fa-regular fa-trash-can m-r-5"></i> Delete</a>
                                                </div>
												</div>
											</td>
										</tr>
										<!-- Edit Department Modal -->
				<div id="edit${company.CompanyId}" class="modal custom-modal fade" role="dialog">
							...
							<div class="modal-body">
								<form action="/editCompany" method="post">
									<div class="input-block mb-3">
										...
										<input class="form-control" value="${company.CompanyName}"  name="companyname" type="text">
										<input class="form-control" value="${company.CompanyId}" name="companyid" type="hidden">
									</div>
				...
				<div class="modal custom-modal fade" id="delete${company.CompanyId}" role="dialog">
						...
						<div class="modal-content">
							<div class="modal-body">
								...
								<div class="modal-btn delete-action">
									<div class="row">
										<div class="col-6">
											<a href="/deleteCompany?companyid=${company.CompanyId}" class="btn btn-primary continue-btn">Delete</a>
										</div>
										<div class="col-6">
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								<form action="/company" method="post">
									...
									<div class="submit-section">
										<button class="btn btn-primary submit-btn" type="submit">Add Company</button>
									</div>
								</form>
							</div>
						</div>
